...
@section('content')
    ...
    <div class="row mb-3">
        <div class="col-lg">
            <h3>Data Masalah Pengaduan</h3>
            <p>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb" style="border: none; margin-left: -15px;">
                    <li class="breadcrumb-item"><a href="#">Dashboard</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Data Masalah Pengaduan</li>
                </ol>
            </nav>
            </p>
        </div>
        ...
        <div class="col-lg">
            <div class="card">
                <div class="card-header">
                    <a href="{{ route('data-masalahpengaduan.create') }}" class="btn btn-primary">
                        <i class="fas fa-plus"></i>
                        Tambahkan Masalah Pengaduan
                    </a>
                </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            let myTable = $('#myTable').DataTable({
                ...
                ajax: {
                    url: "{{ route('data-masalahpengaduan.index') }}",
                    data: function(d) {
                ...
                initComplete: function(settings, json) {
                    ...
                    var editRoute = "{{ route('data-masalahpengaduan.edit', ':id') }}"
                    var deleteRoute = "{{ route('data-masalahpengaduan.destroy', ':id') }}";
                    ...
                    function format(d) {
                        ...
                        return '<table>' +
                            '<tr>' +
                            '<td>Edit Masalah Pengaduan :</td>' +
                            '<td><a href="' + editUrl +
                            '"class="btn btn-info"><i class="fa fa-edit"></i> &nbsp; Edit Masalah Pengaduan</a></td>' +
                            '</tr>' +
                            '<tr>' +
                            '<td>Hapus Masalah Pengaduan</td>' +
                            '<td><form action="' + deleteUrl + '" method="POST" id="dataForm">' +
                            '@csrf' +
                            '<button type="submit" class="btn btn-danger" id="hapusData"><i class="fa fa-times"></i> &nbsp; Hapus Masalah Pengaduan</button>' +
                            '</form></td>' +
                            '</tr>' +
                            '</table>';
                    }
