...
@section('content')
    <div class="row mb-3">
        <div class="col-lg">
            <h3>Tambah Masalah Pengaduan</h3>
            <p>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb" style="border: none; margin-left: -15px;">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Tambah Masalah Pengaduan</li>
                </ol>
            </nav>
            </p>
        </div>
    ...
    <div class="row">
        <div class="col-lg">
            <form action="{{ route('data-masalahpengaduan.store') }}" method="POST">
                @csrf
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <input type="text" name="kode" class="form-control @error('kode') is-invalid @enderror"
                                value="{{ old('kode') }}" placeholder="Masukan Kode Kategori">
                            @error('kode')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="nama" class="form-control @error('nama') is-invalid @enderror"
                                value="{{ old('nama') }}" placeholder="Masukan Nama Kategori">
                            @error('nama')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
