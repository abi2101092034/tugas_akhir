...
@section('content')
    ...
    <div class="row">
        <div class="col-lg">
            <form action="{{ route('data-pengaduan.update', $pengaduans->id) }}" method="POST"
                    ...
                    <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="warga_id" class="form-control @error('warga_id') is-invalid @enderror"
                                        ...
                                        @foreach ($wargas as $data)
                                            <option value="{{ $data->id }}"
                                                {{ $pengaduans->warga_id == $data->id ? 'selected' : '' }}>
                                                {{ $data->nama ?? '-' }}</option>
                                        @endforeach
                                    </select>
                                    @error('warga_id')
                            ...
                            <div class="col-lg">
                                <div class="mb-3">
                                    ...
                                    <input type="date" name="tgl_pengaduan"
                                        ...
                                        value="{{ old('tgl_pengaduan', $pengaduans->tgl_pengaduan ?? '') }}">
                                    @error('tgl_pengaduan')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="lokasi" class="form-control @error('lokasi') is-invalid @enderror"
                                value="{{ old('lokasi', $pengaduans->lokasi ?? '') }}"
                                placeholder="Masukan Lokasi Pengaduan">
                            @error('lokasi')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="judul" class="form-control @error('judul') is-invalid @enderror" rows="5"
                                placeholder="Masukan judul pengaduan">{{ old('judul', $pengaduans->judul ?? '') }}</textarea>
                            @error('judul')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="isi_pengaduan" class="form-control @error('isi_pengaduan') is-invalid @enderror" rows="5"
                                placeholder="Masukan keterangan">{{ old('isi_pengaduan', $pengaduans->isi_pengaduan ?? '') }}</textarea>
                            @error('isi_pengaduan')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="mb-3">
                            ...
                            <select name="statuspengaduan"
                                ...
                                <option value="Sudah Tervalidasi"
                                    {{ $pengaduans->statuspengaduan == 'Sudah Tervalidasi' ? 'selected' : '' }}>Sudah
                                    Tervalidasi
                                </option>
                                <option value="Belum Tervalidasi"
                                    {{ $pengaduans->statuspengaduan == 'Belum Tervalidasi' ? 'selected' : '' }}>Belum
                                    Tervalidasi
                                </option>
                            </select>
