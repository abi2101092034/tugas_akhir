        ...
        <div class="col-lg">
            <div class="card">
                <div class="card-header">
                    List Data Pengaduan <span class="badge badge-success">Sudah Tervalidasi</span>
                </div>
                    ...
                    <table class="table table-bordered table-striped" id="myTable">
                        <thead>
                            <tr>
                                ...
                                <th>Lokasi</th>
                                <th>Tanggal</th>
                                <th style="width: 8px">Keterangan</th>
                                <th>Status</th>
                                <th>Foto</th>
                            </tr>
                        </thead>
    ...
    <script>
        $(document).ready(function() {
            ...
            let myTable = $('#myTable').DataTable({
                ...
                ajax: {
                    url: "{{ route('data-sudahtervalidasi.index') }}",
                    data: function(d) {
                ...
                initComplete: function(settings, json) {
                    ...
                    var dikerjakanRoute = "{{ route('data-sudahtervalidasi.dikerjakan', ':id') }}"
                    var showRoute = "{{ route('data-sudahtervalidasi.show', ':id') }}"

                    function format(d) {
                        var dikerjakanUrl = dikerjakanRoute.replace(':id', d.id);
                        ...
                        return '<table>' +
                            ...
                            '<td><form action="' + dikerjakanUrl +
                            '" method="POST" id="dataForm">' +
                            '@csrf' +
                            '<button type="submit" class="btn btn-success"><i class="fa fa-check"></i> &nbsp; Laporan Dikerjakan</button>' +
                            '</form></td>' +
                            '</tr>' +
                            '</table>';
                    }
