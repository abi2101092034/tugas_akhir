        ...
        <div class="col-lg">
            <div class="card">
                <div class="card-header">
                    <a href="{{ route('data-warga.create') }}" class="btn btn-primary">
        ...
        $(document).ready(function() {
            ...
            let myTable = $('#myTable').DataTable({
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, full, meta) {
                            var tmp = full.tmp_lahir;
                            var tgl = full.tgl_lahir;
                            return tmp + ',' + ' ' + tgl;
                        }
                    },
                    {
                ...
                initComplete: function(settings, json) {
                    ...
                    var editRoute = "{{ route('data-warga.edit', ':id') }}"
                    var deleteRoute = "{{ route('data-warga.destroy', ':id') }}";
                    ...
                    function format(d) {
                        ...
                        return '<table>' +
                            ...
                            '<td>Edit Warga :</td>' +
                            '<td><a href="' + editUrl +
                            '"class="btn btn-info"><i class="fa fa-edit"></i> &nbsp; Edit Warga</a></td>' +
                            '</tr>' +
                            '<tr>' +
                            '<td>Hapus Warga</td>' +
                            '<td><form action="' + deleteUrl + '" method="POST" id="dataForm">' +
                            '@csrf' +
                            '<button type="submit" class="btn btn-danger" id="hapusData"><i class="fa fa-times"></i> &nbsp; Hapus Warga</button>' +
                            '</form></td>' +
                            '</tr>' +
                            '</table>';
                    }
