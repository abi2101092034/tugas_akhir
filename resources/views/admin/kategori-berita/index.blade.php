        ...
        <div class="col-lg">
            <div class="card">
                <div class="card-header">
                    <a href="{{ route('data-kategoriberita.create') }}" class="btn btn-primary">
    ...
    <script>
        $(document).ready(function() {
            ...
            let myTable = $('#myTable').DataTable({
                ...
                ajax: {
                    url: "{{ route('data-kategoriberita.index') }}",
                    data: function(d) {
                ...
                initComplete: function(settings, json) {
                    ...
                    var editRoute = "{{ route('data-kategoriberita.edit', ':id') }}"
                    var deleteRoute = "{{ route('data-kategoriberita.destroy', ':id') }}";
                    ...
                    function format(d) {
                        ...
                        return '<table>' +
                            '<tr>' +
                            '<td>Edit Kategori Berita :</td>' +
                            '<td><a href="' + editUrl +
                            '"class="btn btn-info"><i class="fa fa-edit"></i> &nbsp; Edit Kategori Berita</a></td>' +
                            '</tr>' +
                            '<tr>' +
                            '<td>Hapus Kategori Berita</td>' +
                            '<td><form action="' + deleteUrl + '" method="POST" id="dataForm">' +
                            '@csrf' +
                            '<button type="submit" class="btn btn-danger" id="hapusData"><i class="fa fa-times"></i> &nbsp; Hapus Kategori Berita</button>' +
                            '</form></td>' +
                            '</tr>' +
                            '</table>';
                    }
