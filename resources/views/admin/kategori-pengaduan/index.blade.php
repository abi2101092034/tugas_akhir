...
@section('content')
    ...
    <div class="row mb-3">
        <div class="col-lg">
            <h3>Data Kategori Pengaduan</h3>
            <p>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb" style="border: none; margin-left: -15px;">
                    <li class="breadcrumb-item"><a href="#">Dashboard</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Data Kategori Pengaduan</li>
                </ol>
            </nav>
            </p>
        </div>
        ...
        <div class="col-lg">
            <div class="card">
                <div class="card-header">
                    <a href="{{ route('data-kategoripengaduan.create') }}" class="btn btn-primary">
                        <i class="fas fa-plus"></i>
                        Tambahkan Kategori Pengaduan
                    </a>
                </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            let myTable = $('#myTable').DataTable({
                ...
                ajax: {
                    url: "{{ route('data-kategoripengaduan.index') }}",
                    data: function(d) {
                ...
                initComplete: function(settings, json) {
                    ...
                    var editRoute = "{{ route('data-kategoripengaduan.edit', ':id') }}"
                    var deleteRoute = "{{ route('data-kategoripengaduan.destroy', ':id') }}";
                    ...
                    function format(d) {
                        ...
                        return '<table>' +
                            '<tr>' +
                            '<td>Edit Kategori Pengaduan :</td>' +
                            '<td><a href="' + editUrl +
                            '"class="btn btn-info"><i class="fa fa-edit"></i> &nbsp; Edit Kategori Pengaduan</a></td>' +
                            '</tr>' +
                            '<tr>' +
                            '<td>Hapus Kategori Pengaduan</td>' +
                            '<td><form action="' + deleteUrl + '" method="POST" id="dataForm">' +
                            '@csrf' +
                            '<button type="submit" class="btn btn-danger" id="hapusData"><i class="fa fa-times"></i> &nbsp; Hapus Kategori Pengaduan</button>' +
                            '</form></td>' +
                            '</tr>' +
                            '</table>';
                    }
