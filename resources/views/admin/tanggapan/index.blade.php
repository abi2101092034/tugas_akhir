        ...
        <div class="col-lg">
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="{{ route('data-tanggapan.create', $pengaduans->id) }}" class="btn btn-primary">
    ...
    <script>
        $(document).ready(function() {
            ...
            let myTable = $('#myTable').DataTable({
                ...
                ajax: {
                    url: "{{ route('data-tanggapan.index', $pengaduans->id) }}",
                    data: function(d) {
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row) {
                            var datas = row.pengaduan.kode;
                            return '<span class="badge badge-primary">' + datas + '</span>';
                        }
                    },

                    {
                        data: 'pengaduan.judul',
                        defaultContent: '-'
                    },
                    {
                        data: 'pengaduan.isi_pengaduan',
                        visible: false,
                    },
                    {
                        data: 'tgl_tanggapan',
                ...
                initComplete: function(settings, json) {
                    ...
                    var editRoute = "{{ route('data-tanggapan.edit', ':id') }}"
                    var deleteRoute = "{{ route('data-tanggapan.destroy', ':id') }}";
                    ...
                    function format(d) {
                        ...
                        return '<table>' +
                            '<tr>' +
                            '<td>Edit Tanggapan :</td>' +
                            '<td><a href="' + editUrl +
                            '"class="btn btn-info"><i class="fa fa-edit"></i> &nbsp; Edit Tanggapan</a></td>' +
                            '</tr>' +
                            '<tr>' +
                            '<td>Hapus Tanggapan</td>' +
                            '<td><form action="' + deleteUrl + '" method="POST" id="dataForm">' +
                            '@csrf' +
                            '<button type="submit" class="btn btn-danger" id="hapusData"><i class="fa fa-times"></i> &nbsp; Hapus Tanggapan</button>' +
                            '</form></td>' +
                            '</tr>' +
                            '</table>';
                    }
