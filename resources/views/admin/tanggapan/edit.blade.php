...
@section('content')
        ...
        <div class="col-lg">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb" style="border: none; margin-left: -15px;">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Edit Data Tanggapan</li>
                </ol>
            </nav>
            </p>
        </div>
    ...
    <div class="row">
        <div class="col-lg">
            <form action="{{ route('data-tanggapan.update', $tanggapans->id) }}" method="POST">
                @csrf
                <div class="card">
                    <div class="card-header">
                        <a href="{{ route('data-tanggapan.index', $tanggapans->pengaduan_id) }}" class="btn btn-primary">
                    ...
                    <div class="card-body">
                        ...
                        <input type="text" name="pengaduan_id" class="form-control"
                            value="{{ $tanggapans->pengaduan_id }}" hidden>
                        <div class="row">
                            <div class="col-lg">
                                <div class="mb-3">
                                    ...
                                    <input type="date" name="tgl_tanggapan"
                                        ...
                                        value="{{ old('tgl_tanggapan', $tanggapans->tgl_tanggapan) }}">
                                    @error('tgl_tanggapan')
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="isi_tanggapan" class="form-control @error('isi_tanggapan') is-invalid @enderror" rows="5"
                                        placeholder="Masukan keterangan">{{ old('isi_tanggapan', $tanggapans->isi_tanggapan) }}</textarea>
                                    @error('isi_tanggapan')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
