        ...
        <div class="col-lg">
            <div class="card">
                <div class="card-header">
                    <a href="{{ route('data-komentar.create') }}" class="btn btn-primary">
        ...
        $(document).ready(function() {
            ...
            let myTable = $('#myTable').DataTable({
                ...
                initComplete: function(settings, json) {
                    ...
                    var editRoute = "{{ route('data-komentar.edit', ':id') }}"
                    var deleteRoute = "{{ route('data-komentar.destroy', ':id') }}";
                    ...
                    function format(d) {
                        ...
                        return '<table>' +
                            '<tr>' +
                            '<td>Edit Data Komentar :</td>' +
                            '<td><a href="' + editUrl +
                            '"class="btn btn-info"><i class="fa fa-edit"></i> &nbsp; Edit Data Komentar</a></td>' +
                            '</tr>' +
                            '<tr>' +
                            '<td>Hapus Data Komentar</td>' +
                            '<td><form action="' + deleteUrl + '" method="POST" id="dataForm">' +
                            '@csrf' +
                            '<button type="submit" class="btn btn-danger" id="hapusData"><i class="fa fa-times"></i> &nbsp; Hapus Data Komentar</button>' +
                            '</form></td>' +
                            '</tr>' +
                            '</table>';
                    }
