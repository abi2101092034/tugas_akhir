...
@section('content')
        ...
        <div class="col-lg">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb" style="border: none; margin-left: -15px;">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Edit Data Komentar</li>
                </ol>
            </nav>
            </p>
        </div>
    ...
    <div class="row">
        <div class="col-lg">
            <form action="{{ route('data-komentar.update', $komentars->id) }}" method="POST">
                @csrf
                <div class="card">
                                    ...
                                    <select name="pengaduan_id"
                                        ...
                                        @foreach ($pengaduans as $data)
                                            <option value="{{ $data->id }}"
                                                {{ $komentars->pengaduan_id == $data->id ? 'selected' : '' }}>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="warga_id" class="form-control @error('warga_id') is-invalid @enderror"
                                        ...
                                        @foreach ($wargas as $data)
                                            <option value="{{ $data->id }}"
                                                {{ $komentars->warga_id == $data->id ? 'selected' : '' }}>
                                                {{ $data->nama ?? '-' }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-lg">
                                <div class="mb-3">
                                    ...
                                    <input type="date" name="tgl_komentar"
                                        ...
                                        value="{{ old('tgl_komentar', $komentars->tgl_komentar ?? '') }}">
                                    @error('tgl_komentar')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="col-lg">
                                <div class="mb-3">
                                    ...
                                    <textarea name="isi_komentar" class="form-control @error('isi_komentar') is-invalid @enderror" rows="5"
                                        placeholder="Masukan komentar">{{ old('isi_komentar', $komentars->isi_komentar ?? '-') }}</textarea>
                                    @error('isi_komentar')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
