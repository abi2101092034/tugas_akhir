        ...
        <div class="col-lg">
            <div class="card">
                <div class="card-header">
                    List Data Pengaduan <span class="badge badge-success">Sudah Dikerjakan</span>
                </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            let myTable = $('#myTable').DataTable({
                ...
                ajax: {
                    url: "{{ route('data-sudahdikerjakan.index') }}",
                    data: function(d) {
                ...
                initComplete: function(settings, json) {
                    ...
                    var dikerjakanRoute = "{{ route('data-sudahdikerjakan.selesai', ':id') }}"
                    var detailRoute = "{{ route('data-sudahdikerjakan.show', ':id') }}"

                    function format(d) {
                        var detailUrl = detailRoute.replace(':id', d.id);
                        var dikerjakanUrl = dikerjakanRoute.replace(':id', d.id);
                        return '<table>' +
                            '<tr>' +
                            '<td>Detail Pengaduan :</td>' +
                            '<td><a href="' + detailUrl +
                            '"class="btn btn-info"><i class="fa fa-edit"></i> &nbsp; Detail Pengaduan</a></td>' +
                            '</tr>' +
                            '<tr>' +
                            ...
                            '@csrf' +
                            '<button type="submit" class="btn btn-success"><i class="fa fa-check"></i> &nbsp; Laporan Selesai</button>' +
                            '</form></td>' +
                            '</tr>' +
                            '</table>';
                    }
