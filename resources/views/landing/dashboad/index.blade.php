...
@section('title', 'Landing | SILAPOR')
@section('menuLandingBeranda', 'active')

<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>SI LAPOR</title>
    <!-- Link to Bootstrap CSS for modal functionality -->
                    ...
                    <div class="carousel-item active">
                        ...
                        <div class="carousel-caption">
                            <div class="p-3" style="max-width: 900px;">
                                ...
                                <div class="div">
                                    <button class="btn btn-primary" id="readMoreBtn">Layanan Pengaduan</button>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <script>
            $(document).ready(function() {
                $('#readMoreBtn').click(function() {
                    $('#modalContainer').load('path/to/modal.html', function() {
                                ...
                                <div
                                    ...
                                    <div class="service-content text-end">
                                        ...
                                        <p class="mb-0">Dolor sit amet consectetur adipisicing elit. Non alias eum,
                                            suscipit expedita corrupti officiis debitis possimus nam laudantium beatae
                                            quidem dolore consequuntur voluptate rem reiciendis, omnis sequi harum earum.
                                        </p>
                                    </div>
